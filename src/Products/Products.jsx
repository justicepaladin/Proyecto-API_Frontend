...
import { Checkbox, Container, IconButton, ListItemText, MenuItem, OutlinedInput, Select, Typography } from '@mui/material'
    ...
    <>
      ...
      <section className="recently-viewed">
        ...
        <Container sx={{display:"flex", flexDirection:"row", alignItems:"center"}}>
          ...
          <IconButton disabled={page == lastPage} onClick={e => handlePageChange(1)}>
            <ArrowForward/>
          </IconButton>
          ...
          >
            {tagsDisponibles.map((tag) => (
              <MenuItem key={tag.id} value={tag}>
                <Checkbox checked={tagsSeleccionados.find(e => e.id == tag.id) ? true : false} />
