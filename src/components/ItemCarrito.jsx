...
export const ItemCarrito = ({item}) => {
    ...
    return (
        <Card style={{ display: "flex", flexDirection: "row", padding: "1rem", position: "relative", margin: ".4rem" }}>
          
          <IconButton title="Eliminar" onClick={handleEliminarItem} style={{ position: "absolute", top: "0.5rem", right: "0.5rem" }}>
            <Delete color="error" />
          </IconButton>
          ...
          <Box style={{ display: "flex", flexDirection: "column", flex: 1, paddingLeft: "1rem" }}>
            ...
            <Box style={{ display: "flex", alignItems: "center", justifyContent: "center" ,marginTop: "auto" }}>
                ...
                <IconButton onClick={() => handleModificarCantidad(item, -1)}>
                <Remove />
                </IconButton>
        
                <Typography style={{ padding: "0.5rem", textAlign: "center", width: "2rem" }}>
                {item.cantidad}
                </Typography>
